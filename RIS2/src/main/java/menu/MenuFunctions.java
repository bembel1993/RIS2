...
public class MenuFunctions {
   ...
   //    if (Validator.correctPerson(name, surname, age, phone, mail)) {
    ...
    public String addCar() {
        ...
        System.out.print("Введите вид топлива автомобиля: ");
        String fuel = in.nextLine();
        System.out.print("Введите расход топлива автомобиля: ");
        String fuelConsumption = in.nextLine();
        System.out.print("Введите стоимость автомобиля: ");
        int price = Integer.parseInt(in.nextLine());
        //  if (Validator.correctCompany(name, country)) {
        Car car = new Car(name, year, distance, fuel, fuelConsumption, price);
